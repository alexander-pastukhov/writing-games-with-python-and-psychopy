...
As usual, let us start with a minimal code (try doing it from scratch instead of copy-pasting from the last game):
```python
...
### List operations
Our list consists of four unique filenames but in the game each card should appear twice. There are several ways of duplicating lists. We will use list operations for this. Python lists implement two operations:
