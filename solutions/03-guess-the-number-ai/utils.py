"""
Utility functions for guess-the-number AI edition game.

Functions
---------
player_feedback : Get player feedback, prompting until valid input is given.
split_interval : Split the interval (approximatelly) at integer half point.
"""
...
def split_interval(lower_limit, upper_limit):
    ...
    int
    """
    return int((upper_limit + lower_limit) / 2.0)