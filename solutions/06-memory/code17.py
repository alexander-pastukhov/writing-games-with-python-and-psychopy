...
from utilities import create_card, index_from_position, remaining_cards
...
while show_must_go_on and remaining_cards(cards) > 0:
...
# feedback
visual.TextStim(win, "You opened all cards in %.1f seconds!"%(game_clock.getTime())).draw()
win.flip()
event.waitKeys()
