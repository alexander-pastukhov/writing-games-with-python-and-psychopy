...
Let us program Guess the Number game again^[This is the last time, I promise!] but _reverse_ the roles. Now _you_ will pick a number and the computer will guess. In the process, we will learn about functions, documenting them like a pro, writing your own libraries, and a for loop.
...
::: {.infobox .program}
Updated your code in `code02.py`.
:::
