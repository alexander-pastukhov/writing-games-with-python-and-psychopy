...
To implement this program, you will need to learn about functions, how to document them like a pro, and how to use your own libraries. Grab the [exercise notebook](notebooks/05. Guess the number - AI.ipynb) before we start!
