...
## Playing again
Modify the code, so that you can play this game several times. You already know [how to do this](#guess-the-number-repeat-game). The only thing you need to consider is where exactly should you perform initialization before each round.
