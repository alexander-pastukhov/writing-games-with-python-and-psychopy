...
# blank
use while loop to present blank (win.flip() alone) "blank duration" long

# presentation
use while loop to present the target mole "presentation duration" long
...
## Exit strategy
I hope that you used a small number of trials because (on my advice, yes!) there was no possibility to exit the game via the **escape** key. We need to put it back but we have nested loops, which makes things awkward^[You will know how to solve this problem in an easy and elegant way, once we you learn about exceptions and context managers.]. We need to continuously check fo
